    ...
    public class ManifestBehaviour : MonoBehaviour
    {
        ...
        public void Awake()
        {
            if (HighLogic.LoadedScene == GameScenes.FLIGHT)
            {
                ...
                if (toolbarControl == null)
                {
                    ...
                    toolbarControl.AddToAllToolbars(onButtonClick, onButtonClick,
                        ApplicationLauncher.AppScenes.FLIGHT,
                        RegisterToolbar.MODID,
                         "MCESpacecenter_Button",
                         "CrewManifest/Icons/IconOff_38",
                         "CrewManifest/Icons/IconOff_24",
        ...
        public void OnGUI()
        {
            ...
            if (Settings.ShowDebugger)
                Settings.DebuggerPosition = ClickThruBlocker.GUILayoutWindow(398643, Settings.DebuggerPosition, DrawDebugger, "Manifest Debug Console", GUILayout.MinHeight(20));
        }
